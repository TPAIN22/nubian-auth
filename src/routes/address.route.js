...
import { validateAddressWrite } from '../middleware/validators/address.validator.js';

const router = express.Router();

router.get('/',  isAuthenticated, requireUser, getAddresses);
router.post('/', isAuthenticated, requireUser, validateAddressWrite, handleValidationErrors, addAddress);

router.put('/:id',           isAuthenticated, requireUser, ...validateObjectId('id'), validateAddressWrite, handleValidationErrors, updateAddress);
